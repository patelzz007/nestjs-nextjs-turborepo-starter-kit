 ...
 *
 * The view is the **smart component** (rules 9–10): it owns the data (here a
 ...
 *
 * The route id arrives as a prop from the server `page.tsx` (which owns
 * `params`), keeping this client component free of `useParams`.
 */
export default function UserDetailView({ userId }: { readonly userId: string }): React.JSX.Element {
