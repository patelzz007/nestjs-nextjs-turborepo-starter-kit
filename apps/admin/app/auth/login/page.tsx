        ...
        <div className="relative z-10 flex max-w-md flex-col gap-6">
          ...
          <blockquote className="space-y-3">
            <p className="text-lg leading-relaxed text-foreground/90">
              &ldquo;The admin panel gives me complete visibility into our operations.
              I can manage users, monitor activity, and control permissions — all
              from one place.&rdquo;
            </p>
          ...
          <p className="text-xs text-muted-foreground">
            Enterprise-grade security. Used by leading companies worldwide.
          </p>
        </div>
      </div>
    </div>
