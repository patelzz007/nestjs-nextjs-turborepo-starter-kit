		...
		<div className="flex min-h-svh items-center justify-center p-8">
			<div className="w-full max-w-lg space-y-8">
				...
				<div className="text-center">
					...
					<h1 className="mt-4 text-2xl font-bold tracking-tight">Admin Dashboard</h1>
					<p className="mt-1 text-sm text-muted-foreground">Welcome, {user?.fullName ?? "Administrator"}</p>
					...
					<div className="rounded-lg border bg-card p-6 text-card-foreground shadow-xs">
						...
						<div className="space-y-2">
							{user.permissions.slice(0, 8).map((perm) => (
								<div key={perm.id} className="flex items-center justify-between rounded-md bg-muted/50 px-3 py-2 text-xs">
