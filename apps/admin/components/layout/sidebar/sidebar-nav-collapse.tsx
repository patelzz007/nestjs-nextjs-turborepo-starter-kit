...
export interface SidebarNavCollapseProps {
	readonly open: boolean;
	readonly children: React.ReactNode;
	readonly className?: string;
}

/** Height + opacity collapse — keeps subtree mounted so close animates smoothly. */
export function SidebarNavCollapse({ open, children, className }: SidebarNavCollapseProps): React.JSX.Element {
	return (
		<div
