...
import type { SidebarWorkspace } from "@/components/layout/sidebar/sidebar-workspace-switcher";
			...
			<SidebarFooter className="border-t border-sidebar-border bg-sidebar-accent/10">
					...
					<div className="flex items-center gap-1 px-2">
						{footerActions.map((action) => (
							<Button
								...
								className="gap-1.5 px-2 py-1 text-xs text-muted-foreground/60 hover:bg-sidebar-accent hover:text-sidebar-foreground">
				...
				<div className="flex items-center justify-between px-2 py-2">
					...
					<Button
						...
						className="text-muted-foreground/60 hover:bg-sidebar-accent hover:text-sidebar-foreground"
