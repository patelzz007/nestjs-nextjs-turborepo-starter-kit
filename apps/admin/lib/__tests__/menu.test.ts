...
import { buildSidebarView, computeRouteState, filterItemsBySearch, flattenMenuItems, isRouteActive, sectionHasActiveItem } from "@/lib/menu";
import { compileMenu } from "@/config/sidebar-menu";
import type { CompiledSidebarMenuItem, SidebarMenuData } from "@/types/sidebar";
