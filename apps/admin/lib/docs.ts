...
import { estimateReadingTime, extractTocHeadings, parseMarkdownFile, stripFirstHeading, type TocHeading } from "@/lib/markdown";
...
interface RawDoc extends DocSummary {
