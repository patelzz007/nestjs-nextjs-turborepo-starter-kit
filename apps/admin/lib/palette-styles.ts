...
/**
 * Deterministically picks a unique colour for each item title.
 * Same title always gets the same colour; different titles get different colours.
 */
