...
-- ============================================================================
-- Row-Level Security (RLS) — Production RBAC + ACL + RLS Architecture
-- ============================================================================
-- This RLS setup is integrated into the migration as per the production
-- RBAC + ACL + RLS architecture specification. The following sections define:
--
-- 1. app_runtime role (restricted, non-superuser)
-- 2. RLS helper functions (app_rls_bypass, app_current_user_id, etc.)
-- 3. Enable RLS on all tables
-- 4. Generic RLS policies (ownership, organization membership, branch access)
--
-- These policies are GENERIC and operate on:
-- - User ownership (app_owns)
-- - Organization membership (app_organization_member_of)
-- - Tenant context (app_tenant_organization_member_of)
--
-- Roles and permissions are APPLICATION DATA, not RLS infrastructure.
-- Administrators can create/modify roles without changing these policies.
-- ============================================================================


-- ============================================================================
-- Row-Level Security (RLS) — Production Architecture
-- Integrated into migration as per RBAC + ACL + RLS spec
-- ============================================================================
