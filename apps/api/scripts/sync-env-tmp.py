...
PLACEHOLDER: dict[str, str] = {
    ...
    "JWT_ACCESS_SECRET": "change-me-run-pnpm-secrets-generate",
    "JWT_ACCESS_EXPIRY": "15m",
    "JWT_REFRESH_SECRET": "change-me-run-pnpm-secrets-generate",
    "JWT_REFRESH_EXPIRY": "7d",
    "EMAIL_VERIFICATION_SECRET": "change-me-run-pnpm-secrets-generate",
    "TWO_FACTOR_PENDING_SECRET": "change-me-run-pnpm-secrets-generate",
...
def build(real: bool) -> str:
    ...
    lines = [
        ...
        "",
        "# ── Auth / JWT ───────────────────────────────",
        "# Generate each secret with: openssl rand -base64 128",
        ...
        f"TWO_FACTOR_PENDING_SECRET={v['TWO_FACTOR_PENDING_SECRET']}",
