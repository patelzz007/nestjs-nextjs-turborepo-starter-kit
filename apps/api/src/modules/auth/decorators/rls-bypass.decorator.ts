 ...
 * boundaries (signup/login, signed webhooks). Do **not** combine with session
 * refresh/logout — those routes have `request.user` from the refresh token and
 * should stay scoped to `sub`.
 *
