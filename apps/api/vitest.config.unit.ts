...
export default defineConfig({
	test: {
		...
		// Scoped to the notifications/email suite: the legacy specs under
		// src/modules/* were never wired to a runner (jest-style + unresolved
		// Nest DI) and predate this config.
		include: ["src/modules/notifications/**/*.spec.ts"],
