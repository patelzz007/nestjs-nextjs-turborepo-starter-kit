...
export default defineConfig({
	test: {
		...
		// Scoped to the wired suites: notifications/email + telescope + the common
		...
		include: ["src/modules/notifications/**/*.spec.ts", "src/modules/telescope/**/*.spec.ts", "src/common/pipes/*.spec.ts"],
