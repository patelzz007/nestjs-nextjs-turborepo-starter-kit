		...
		<figure className="group/image not-prose my-8">
			<div className="relative overflow-hidden rounded-xl border border-border/40 bg-muted/20">
				...
				<Button
					...
					className="absolute right-3 bottom-3 size-8 rounded-full bg-black/50 text-white opacity-0 shadow-sm backdrop-blur-sm transition-all duration-200 group-hover/image:opacity-100 focus-visible:opacity-100 max-lg:opacity-100"
