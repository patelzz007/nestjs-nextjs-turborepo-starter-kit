					...
					<figure
						...
						<div className="bg-dot-grid relative h-56 overflow-hidden bg-muted/40 sm:h-64">
							...
							<Button
								...
								className="absolute right-3 bottom-3 rounded-full bg-black/55 py-1.5 pr-3 pl-2.5 text-xs font-medium text-white opacity-0 shadow-md backdrop-blur-sm transition-all duration-200 group-hover/gallery:opacity-100 hover:bg-black/70 focus-visible:opacity-100 max-lg:opacity-100"
