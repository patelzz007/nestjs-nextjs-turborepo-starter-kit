...
/**
 * MermaidDiagram — renders a mermaid diagram source string to SVG. The heavy
 * `mermaid` library is dynamic-imported inside the effect, so it is
 * code-split into its own chunk and only ever loaded when a real ```mermaid
