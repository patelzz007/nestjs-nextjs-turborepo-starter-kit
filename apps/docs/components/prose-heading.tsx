...
function CopyHeadingButton({ id }: { readonly id: string }): React.JSX.Element {
	...
	return (
		<button
			type="button"
			onClick={handleCopy}
			className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-md opacity-0 transition-all duration-200 group-hover/heading:opacity-100 hover:bg-muted focus-visible:opacity-100"
