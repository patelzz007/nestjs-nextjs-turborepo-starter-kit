...
export function WebNotificationsDropdown(): React.JSX.Element {
	const [notifications, setNotifications] = React.useState<readonly WebNotificationItem[]>(WEB_NOTIFICATIONS_DATA.notifications);
