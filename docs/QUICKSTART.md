...
- **NestJS API** (Fastify adapter) — REST endpoints, JWT auth, RBAC, email, telescope observability
- **Next.js Admin Panel** — dashboard for managing users, backups, telescope, emails
