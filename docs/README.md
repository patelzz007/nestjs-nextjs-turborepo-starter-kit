...
| **[Team Member Invitations](./team-invite.md)**        | End-to-end staff invite flow: admin send, public validate/accept, new-account registration, email verification, RLS bypass, and local testing. |
