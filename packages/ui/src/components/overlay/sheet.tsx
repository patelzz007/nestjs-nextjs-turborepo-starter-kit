...
const SheetOverlay = React.forwardRef<HTMLDivElement, SheetPrimitive.Backdrop.Props>(function SheetOverlay({ className, ...props }, ref): React.JSX.Element {
	return (
		<SheetPrimitive.Backdrop
			...
			className={cn(
				"fixed inset-0 z-overlay bg-black/10 transition-opacity duration-150 data-ending-style:opacity-0 data-starting-style:opacity-0 supports-backdrop-filter:backdrop-blur-xs",
				className,
			)}
			{...props}
		/>
