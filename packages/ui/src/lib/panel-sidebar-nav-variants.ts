...
export const panelSidebarNavIconVariants = cva("mr-3 h-4 w-4 shrink-0 transition-colors duration-200", {
	variants: {
		state: {
			default: "text-sidebar-foreground/50 group-hover:text-sidebar-foreground/80",
			active: "text-sidebar-primary-foreground group-hover:text-sidebar-primary-foreground",
...
export const panelSidebarNavChevronVariants = cva("h-3.5 w-3.5 shrink-0 transition-[transform,color] duration-200 ease-out motion-reduce:transition-none", {
	variants: {
		...
		state: {
			...
			active: "text-sidebar-primary-foreground/80 group-hover:text-sidebar-primary-foreground/80",
			disabled: "text-muted-foreground",
		},
	},
	compoundVariants: [
		{ expanded: true, state: "default", class: "rotate-90 text-sidebar-foreground/70" },
		{ expanded: true, state: "active", class: "rotate-90 text-sidebar-primary-foreground/80 group-hover:text-sidebar-primary-foreground/80" },
	],
	defaultVariants: {
		expanded: false,
		state: "default",
